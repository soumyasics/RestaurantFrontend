...
function Customerlogin() {
  ...
  return (
    ...
    <form >
        ...
        <div class="p-2 w-100" > <h2 class="text-center mt-3 mb-3" >Customer Login Form</h2></div>
        ...
        <div class="text-center mt-3 mb-3"><a href='/Forgetpassword' style={{textDecoration:"none",color:"red"}}>Forget password</a></div>
        </div>
    </form>
    </div>
  )
